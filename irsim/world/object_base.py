...
class ObjectBase:
    ...
    def plot_goal(
        ...
        **kwargs,
        ...
        if (self.shape == "multipolygon" or self.shape == "mosaic" or self.shape == "tractor_trailer") and isinstance(vertices, list):
            goal_patch_list = []
            for v in vertices:
    ...
    def plot_trail(
        ...
        **kwargs,
        ...
        elif (trail_type == "multipolygon" or trail_type == "mosaic" or trail_type == "tractor_trailer") and isinstance(vertices, list):
            for v in vertices:
                trail = MplPolygon(
                    v.T,
                    edgecolor=trail_color,
